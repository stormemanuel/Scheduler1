    ...
    <div className="grid" style={{ gap: 16 }}>
      ...
      <section className="card">
        ...
        <div className="grid grid-3" style={{ marginTop: 12 }}>
          ...
          <label className="field"><span>Estimated revenue</span><input type="number" min="0" value={form.estimated_revenue === "0" ? "" : form.estimated_revenue} onFocus={(e) => e.currentTarget.select()} onChange={(e) => setForm((c) => ({ ...c, estimated_revenue: e.target.value }))} placeholder="0" /></label>
          <label className="field"><span>Probability %</span><input type="number" min="0" max="100" value={form.probability === "0" ? "" : form.probability} onFocus={(e) => e.currentTarget.select()} onChange={(e) => setForm((c) => ({ ...c, probability: e.target.value }))} placeholder="0" /></label>
        </div>
