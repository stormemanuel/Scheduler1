...
function EventsClientInner({
  ...
  const defaultEventDisplayMode: EventDisplayMode = normalize(currentUserRole) === "coordinator" ? "booth" : "day";
  ...
  useEffect(() => {
    ...
    const allowedModes: EventDisplayMode[] = ["day", "booth", "messages", "checklist", "notes", "ratings"];
  ...
  function callCapacitySummary(call: SubCallRecord) {
    ...
    return { filled, needed, full: Boolean(needed > 0 && filled >= needed) };
  }
