      ...
      <section className="card accent-card">
        <div className="row" style={{ alignItems: "center" }}>
          ...
          <div className="toolbar" style={{ justifyContent: "flex-end" }}>
            ...
            <button className="ghost" type="button" onClick={exportOwnerPL}>Export Company P&L</button><button className="ghost" type="button" onClick={exportOwnerPLWithReserves}>Optional reserve export</button><button className="ghost" type="button" onClick={export1099Prep}>Export 1099-NEC Prep</button></div>
        </div>
