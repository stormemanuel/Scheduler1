...
function buildExportHtml(document: ExportDocument) {
  ...
  const sections = document.sections.map((section) => {
    ...
    return `<section class="export-section${section.headingStyle === "day-bar" ? " day-section" : ""}" style="--accent-color: ${rawAccentColor}; background: ${accentBackground}; border-left-color: ${rawAccentColor};">
...
<body>
  <div class="header${document.showLogo ? " header-with-logo" : ""}">
    ${document.showLogo ? `<img src="/els-logo.png" alt="Emanuel Labor Services" class="export-logo" />` : ""}
