...
const crewPayDefaults: Record<string, CrewPayDefault> = {
  ...
  "avt working lead": { fullDay: 400, halfDay: 200 },
  "av tech working lead": { fullDay: 400, halfDay: 200 },
  "audio visual tech working lead": { fullDay: 400, halfDay: 200 },
  ...
  "stage tech": { fullDay: 300, halfDay: 150 },
  stagetech: { fullDay: 300, halfDay: 150 },
  "truck loader": { fullDay: 300, halfDay: 150 },
  loader: { fullDay: 300, halfDay: 150 },
  "warehouse prep": { fullDay: 300, halfDay: 150 },
  "warehouse worker": { fullDay: 300, halfDay: 150 },
  "warehouse workers": { fullDay: 300, halfDay: 150 },
  warehouse: { fullDay: 300, halfDay: 150 },
  ...
  "camera op": { fullDay: 500, halfDay: null },
  "cam op": { fullDay: 500, halfDay: null },
  "ptz camera operator": { fullDay: 500, halfDay: null },
  "ptz cam op": { fullDay: 500, halfDay: null },
  "robotic camera operator": { fullDay: 500, halfDay: null },
  "camera owner operator": { fullDay: 500, halfDay: null },
...
export const crewRoleRateOptions: CrewRoleRateOption[] = [
  { roleName: "General AV", fullDay: 350, halfDay: 175, featured: true },
  { roleName: "AVT / Working Lead", fullDay: 400, halfDay: 200, featured: true },
  ...
  { roleName: "Warehouse Worker", fullDay: 300, halfDay: 150, featured: true },
  { roleName: "Truck Loader", fullDay: 300, halfDay: 150 },
  ...
  { roleName: "Down Rigger", fullDay: 400, halfDay: 200 },
  ...
  { roleName: "Camera Operator (PTZ)", fullDay: 500, halfDay: null },
];
...
export function getDefaultCrewPay(roleName: string | null | undefined): CrewPayDefault | null {
  ...
  if (/working lead|crew lead/.test(role) && (/\bavt\b|av tech|audio visual|general av/.test(role))) return crewPayDefaults["avt working lead"] || crewPayDefaults["crew lead"];
  ...
  if (/truck loader|loader|warehouse|warehouse worker|warehouse workers|warehouse prep|unload/.test(role)) return crewPayDefaults["warehouse worker"];
  if (/stagehand|stage hand|stage tech|stagetech/.test(role)) return crewPayDefaults.stagehand;
  if (/camera|\bptz\b|cam op|camera op|robotic/.test(role)) return crewPayDefaults["camera operator"];
  if (/speaker ready|graphics|playback|zoom|record|lighting designer|\bld\b/.test(role)) return crewPayDefaults["speaker ready"];
  return null;
}
...
export const defaultNewCrewRoleNames = ["General AV", "AVT / Working Lead", "LED Stagehand"] as const;

export function defaultNewCrewPositions() {
  return defaultNewCrewRoleNames.map((roleName) => ({
    role_name: roleName,
    rate: getDefaultCrewPayRate(roleName),
  }));
}
