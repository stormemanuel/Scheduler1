                            ...
                            <div className="card compact" style={{ marginTop: 10, minWidth: 360 }}>
                              <div style={{ borderBottom: "1px solid var(--line)", paddingBottom: 14, marginBottom: 14 }}>
                                ...
                                <div className="grid grid-2" style={{ marginTop: 10 }}>
                                  <div className="field"><span>Current status</span><strong>{purchaseOrderStatusLabel(row.purchaseOrder?.status)}</strong>{row.purchaseOrder?.approvalDueAt ? <span className="small muted">Due {new Date(row.purchaseOrder.approvalDueAt).toLocaleString()}</span> : null}</div>
                                ...
                                {previewPurchaseOrderKey === row.key ? <div style={{ marginTop: 14, border: "2px solid #0f5f3d", borderRadius: 14, overflow: "hidden" }}>
                                  <div style={{ padding: "14px 16px", background: "#f5faf7", borderBottom: "1px solid var(--line)" }}><div className="small muted">Contractor preview</div><strong style={{ fontSize: 18 }}>Purchase Order — {row.showName}</strong><div className="small muted">{row.crewName} · {[row.showClient, row.showVenue].filter(Boolean).join(" · ")}</div></div>
