...
export default async function UsersPage() {
  ...
  let coordinatorCompensationSetupMissing = false;
  ...
  if (!admin) {
    ...
    coordinatorCompensationSetupMissing = Boolean(coordinatorCompensationRes.error && /coordinator_compensation_settings|schema cache|relation/i.test(coordinatorCompensationRes.error.message || ""));
  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      <section className="card">
        ...
        {coordinatorCompensationSetupMissing ? (
          <p className="error" style={{ marginTop: 12 }}>
            Coordinator compensation settings are not installed yet. Run the ELS295 coordinator compensation SQL before saving negotiated coordinator rates.
          </p>
        ) : null}
      </section>
