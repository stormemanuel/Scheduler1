...
export default function ClientsClient({
  ...
  const [clientPricesOpen, setClientPricesOpen] = useState(false);
          ...
          <div className="card">
            ...
            <div className="card compact" style={{ background: "#fbfcfd", marginTop: 14 }}>
              <div className="row" style={{ alignItems: "flex-end", gap: 12 }}>
                ...
                <button type="button" className="ghost" onClick={() => setClientPricesOpen((open) => !open)}>
                  {clientPricesOpen ? "Hide prices" : "Edit prices"}
                </button>
              </div>
