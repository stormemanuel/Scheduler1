  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      ...
      <EventsClient
        ...
        initialPastTotal={pastGrandTotal}
        initialPastMatchTotal={pastTotal}
        initialPastPage={pastPage}
