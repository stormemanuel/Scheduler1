            ...
            <div className="card compact accent-card" style={{ boxShadow: "0 12px 26px rgba(15, 61, 68, 0.12)", marginTop: 12, borderWidth: 3, borderColor: "#d9a51b", background: "#fffaf0" }}>
              ...
              <div className="grid grid-2" style={{ marginTop: 10 }}>
                ...
                <label className="row small" style={{ alignItems: "flex-start", justifyContent: "flex-start" }}>
                  ...
                  <span><strong>Resend updated schedules already marked sent</strong><span className="muted" style={{ display: "block" }}>Use this after changing a worker's days, area, sub-call, time, or rate. Default off to avoid accidental duplicate texts.</span></span>
                </label>
              </div>
              {combinedScheduleSummary ? (
                <div className="card compact" style={{ boxShadow: "none", marginTop: 10, background: "#fbfcfd" }}>
