...
function EventsClientInner({
  ...
  function callPayloadFromPosition(row: MultiPositionDraft) {
    ...
    return {
      ...
      role_name: roleName,
      master_rate_id: row.master_rate_id || null,
  ...
  async function saveCall() {
    ...
    const extraPositionPayloads = editingCallId ? [] : multiPositionRows.map(callPayloadFromPosition);
          ...
          <div className="grid" style={{ gap: 14, marginTop: 12 }}>
            ...
            {!editingCallId ? (
              <div className="card compact" style={{ marginTop: 12, background: "#fbfcfd", boxShadow: "none" }}>
                <div className="row" style={{ alignItems: "flex-start" }}>
                  <div>
                    <strong>Additional positions / time blocks</strong>
                    <div className="small muted">
                ...
                {multiPositionRows.length ? (
                            ...
                            <label className="field">
                              ...
                              <select
                                ...
                                onChange={(event) => {
                                  ...
                                  updateMultiPositionRow(row.id, { master_rate_id: option?.id || "", role_name: option?.role_name || "" });
                                }}
                              >
                  ...
                  <p className="small muted" style={{ marginBottom: 0 }}>No extra position rows added. The main sub-call above will still save normally.</p>
                )}
              </div>
            ) : null}
