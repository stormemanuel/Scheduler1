    ...
    <div className="grid" style={{ gap: 16 }}>
      ...
      <section className="card">
        ...
        <div className="toolbar" style={{ marginTop: 12 }}>
          ...
          <span className="muted small">Matches by email/phone, reuses an active link when available, and otherwise creates a hidden pending contact. Full-onboarding reminders repeat every two weeks and stop automatically after submission.</span>
        </div>
