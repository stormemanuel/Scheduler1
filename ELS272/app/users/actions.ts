...
const roleDefaults: Record<string, { pages: AppPageKey[]; restrictEvents: boolean; restrictCrew: boolean; canEditEventDetails: boolean }> = {
  owner: { pages: ["overview", "coordinator", "crew", "events", "clients", "pipelines", "payroll", "users", "settings"], restrictEvents: false, restrictCrew: false, canEditEventDetails: true },
  admin: { pages: ["overview", "coordinator", "crew", "events", "clients", "pipelines", "payroll", "users", "settings"], restrictEvents: false, restrictCrew: false, canEditEventDetails: true },
  coordinator: { pages: ["overview", "coordinator", "events", "crew"], restrictEvents: true, restrictCrew: true, canEditEventDetails: false },
...
const allowedPages = new Set<AppPageKey>(["overview", "coordinator", "crew", "events", "clients", "pipelines", "payroll", "users", "settings"]);
