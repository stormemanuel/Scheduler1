          ...
          {canSendOnboarding ? (
            <button
              ...
              onClick={() => {
                ...
                const confirmed = window.confirm(
                  `Create a secure full-onboarding link for ${record.name} and send/queue it using your account messaging mode? Android/Samsung users must be on the phone to open Messages directly.`,
                );
