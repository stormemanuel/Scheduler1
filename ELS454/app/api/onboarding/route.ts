...
async function onboardingSenderContext(allowPreview = false) {
  ...
  return {
    ...
    context: {
      ...
      messagingMode: normalizeMessagingMode((session.profile as { messaging_mode?: string | null } | null)?.messaging_mode),
...
async function requireOnboardingAccess() {
  ...
  return {
    ...
    fullName:
      ...
      safeText(user.email) ||
      "ELS Coordinator",
    messagingMode: normalizeMessagingMode((profile as { messaging_mode?: string | null } | null)?.messaging_mode),
