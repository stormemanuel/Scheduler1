        ...
        <div className="list">
          <div className="card compact" style={{ background: "#fbfcfd" }}>
            <div className="row" style={{ alignItems: "flex-start", gap: 12 }}>
              <div>
                <h3 style={{ marginTop: 0 }}>Onboarding</h3>
                <p className="muted small">Send the secure full onboarding packet to crew in your pool and track its progress. W-9 files, contracts, tax details, approvals, and document downloads remain available only to Owner/Admin.</p>
              </div>
            ...
            <div className="grid grid-2">
              ...
              <InfoRow label="W-9 progress" value={statusLabel(record.w9_status || "missing", documentStatusOptions)} />
              <InfoRow label="Contract progress" value={statusLabel(record.contract_status || "missing", documentStatusOptions)} />
