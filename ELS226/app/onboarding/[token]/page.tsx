...
import { use, useEffect, useRef, useState, type PointerEvent, type ReactNode } from "react";
...
function generatedSignatureDataUrl(name: string, style: string) {
  ...
  ctx.font = `${style === "simple" ? 62 : 78}px ${signatureFont(style)}`;
  ctx.textBaseline = "middle";
  ctx.fillText(name, 42, 112, 815);
        ...
        <div className="grid" style={{ gap: 10 }}>
          ...
          >
            ...
            <div className="muted small">
              Generated from the signer name. The signer must certify and submit
              it as their electronic signature.
            </div>
          </div>
          <button
            className="ghost"
          ...
          <div className="grid grid-2">
            <label className="field">
              ...
              <select
                ...
                onChange={(event) =>
                  setField("tin_type", event.target.value as "ssn" | "ein")
                }
              >
        ...
        >
              ...
              >
                {uploadStatus.contract?.text ||
                  (form.contract_document_url
                    ? "Contract saved privately for ELS review."
                    : "Upload a signed copy if you already have one.")}
              </span>
            </label>
          </div>
          ...
          <div className="grid" style={{ gap: 12, marginTop: 14 }}>
            ...
            <label className="field checkboxField">
              <span>
                I understand ELS will provide/collect the contractor agreement
                and W-9 through the secure onboarding process.
              </span>
              <input
                type="checkbox"
