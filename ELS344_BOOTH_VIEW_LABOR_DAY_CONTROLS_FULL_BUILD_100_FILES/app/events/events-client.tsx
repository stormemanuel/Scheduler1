    ...
    return `
      <section class="sheet-page">
        ...
        <table class="attendance-table">
          <thead>
            <tr class="repeat-id"><th colspan="10">Emanuel Labor Services LLC – Sign In / Sign Out Sheet • ${signInSheetHtmlEscape(selectedShow.name)} — ${signInSheetHtmlEscape(identifierDate)}</th></tr>
            <tr>
              ...
              <th class="col-time">Dinner Out</th>
              <th class="col-time">Dinner In</th>
        ...
        <footer class="sheet-footer">
          <div class="instructions">
            ...
            <ol>
              ...
              <li>Record the start and end times for your <strong>Lunch</strong> and <strong>Dinner</strong> breaks.</li>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .col-number { width: 0.36in; text-align: center; }
  .col-name { width: 1.92in; }
  .col-role { width: 1.18in; }
  .col-time { width: 0.72in; }
  .col-signature { width: 1.78in; }
        ...
        <div className="card compact">
          ...
          <div className="card compact" style={{ marginTop: 14, background: "#fbfcfd" }}>
            ...
            <div className="card compact" style={{ boxShadow: "none", marginTop: 12 }}>
              ...
              <div className="small muted">Full-show schedule buttons always send each crew member every assignment they have for the entire show. Reminder buttons remain focused on the next or selected labor day. Each Shortcut run can pull up to 25 due texts.</div>
              <label className="field" style={{ marginTop: 10 }}>
