...
function buildSquarespaceIntroMessage(record: CrewRecord) {
  ...
  return [
    ...
    `I appreciate you reaching out, and I look forward to learning more about your experience. God bless.`
  ].join("\n\n");
}
...
export default function CrewClient({ cityPools: initialCityPools, crewGroups: initialGroups, initialCrew, masterRates, initialRatings }: CrewClientProps) {
  ...
  function exportVisibleContacts() {
    const headers = ["Name", "City", "Group", "Tier", "Email", "Phone", "Lead from", "Primary Role", "Rates", "OB", "Blacklisted", "Blacklist Reason", "Conflicts", "Unavailable Dates", "Notes"];
