...
function EventsClientInner({
  ...
  async function ensureUniversalShortcutPollUrl(showToast = false) {
    ...
    const savedToken = isPersonalShortcutToken(automationDraft.shortcut_token) ? safeText(automationDraft.shortcut_token) : "";
    const token = savedToken || personalShortcutToken || await loadPersonalShortcutToken(showToast);
...
<body>
  ...
  async function testShortcutJson(url: string, label = "Shortcut URL") {
    let targetUrl = url;
    if (!targetUrl) {
      targetUrl = await ensureUniversalShortcutPollUrl(true);
    }
    if (!targetUrl) {
  ...
  function renderAutomationPanel() {
    ...
    const effectiveShortcutToken = savedShortcutIsPersonal ? savedShortcutToken : personalShortcutToken;
      ...
      <div className="list">
          ...
          {automationDraft.sending_method === "shortcut" ? (
            <div className="card compact accent-card" style={{ marginTop: 14 }}>
              ...
              <div className="toolbar">
                ...
                <button type="button" className="ghost" onClick={() => void testShortcutJson(universalShortcutPollUrl, "Shortcut test")}>Test Shortcut JSON</button>
        ...
        <div className="card compact">
          <div className="row" style={{ alignItems: "flex-start" }}>
            ...
            <div className="toolbar" style={{ justifyContent: "flex-end" }}>
              <button type="button" className="ghost" onClick={() => void testShortcutJson(universalShortcutPollUrl, "Shortcut pull test")} disabled={saving}>Test Shortcut Pull</button>
