        ...
        return [
          {
            ...
            accentColor: form.areaName ? accentColorForArea(form.areaName) : "#0f766e",
            paragraphs: [
    ...
    return (
      <div className="list">
        <div className="card compact feedback-intro-card">
          ...
          <div className="toolbar" style={{ marginTop: 12 }}>
            <button type="button" className="primary" onClick={openFeedbackSurvey}>Open Fillable Survey</button>
            <button type="button" className="ghost" onClick={exportFeedbackFormsHtml}>Download HTML Survey</button>
        ...
        {feedbackForms.length ? feedbackForms.map((form) => (
          <form key={form.key} className="card feedback-survey-card" onSubmit={(event) => event.preventDefault()}>
            ...
            <div className="toolbar" style={{ marginTop: 12 }}>
              <button type="button" className="primary" onClick={openFeedbackSurvey}>Open fillable version</button>
              ...
              <div className="card compact">
                ...
                <div className="toolbar" style={{ marginTop: 12 }}>
                  ...
                  {eventDisplayMode === "messages" ? (
                    ...
                    <>
                      <button type="button" className="primary" onClick={openFeedbackSurvey}>Open Fillable Survey</button>
                      <button type="button" className="ghost" onClick={exportFeedbackFormsHtml}>HTML</button>
                      <button type="button" className="ghost" onClick={exportFeedbackFormsPdf}>PDF</button>
                      <button type="button" className="ghost" onClick={exportFeedbackFormsDocx}>DOCX</button>
