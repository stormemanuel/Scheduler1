    ...
    try {
      const response = await fetch("/api/onboarding", {
        ...
        body: JSON.stringify({
          ...
          w9_use_digital: requestType !== "contract_only",
          ...form,
        }),
      });
      const result = await response.json().catch(() => ({}));
    ...
    const completion =
      requestType === "w9_only"
        ...
        : requestType === "contract_only"
          ...
          : {
              title: "Thank you for uploading your onboarding documents!",
              detail: "Your completed onboarding packet was submitted to Emanuel Labor Services for review.",
            };
    ...
    <main style={{ maxWidth: 940, margin: "32px auto", padding: "0 16px" }}>
      ...
      <section className="card" style={{ marginTop: 16 }}>
        ...
        >
          ...
          <p className="muted small">
            Profile photos are compressed to WebP around 800×800. The completed
            in-app W-9 and contract are generated as private PDF records. After
            Emanuel Labor Services approves the onboarding packet, the PDFs are
            archived to secure Google Drive storage when connected.
          </p>
