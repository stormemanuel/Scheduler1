...
export default async function PayrollPage() {
  ...
  const { crewRows, availableYears, loadedYear, setupMissing, error } = await getPayrollPageData();
  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      ...
      <PayrollClient initialRows={crewRows} availableYears={availableYears} initialYear={loadedYear} initialError={error} />
    </div>
  );
}
