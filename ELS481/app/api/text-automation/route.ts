...
async function buildFullShowReminderPlan(
  ...
  for (const row of (existingRes.data || []) as Array<{ id?: string | null; crew_id: string | null; message_type: string | null; reminder_key: string | null; status: string | null; queued_by_user_id?: string | null; delivery_mode?: string | null }>) {
