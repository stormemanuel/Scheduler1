...
<main>
  ...
  function renderSignInSheetModal() {
    ...
    return (
      <div className="card compact accent-card" role="dialog" aria-label="Sign In / Sign Out Sheet" style={{ marginTop: 10, maxWidth: 860, boxShadow: "0 14px 32px rgba(4, 33, 38, .12)" }}>
          <div className="row" style={{ alignItems: "flex-start" }}>
            <div>
