        ...
        <div className="card compact">
          ...
          <div className="card compact" style={{ marginTop: 14, background: "#fbfcfd" }}>
            ...
            <div className="card compact accent-card" style={{ boxShadow: "none", marginTop: 12 }}>
              <div className="row" style={{ alignItems: "flex-start" }}>
                <div>
                  <strong>Send Schedule and Future Reminders</strong>
                  <div className="small muted">Normal setup action. Queues the full-show iMessage schedule due now, then schedules the checked future reminders at their real due times.</div>
                </div>
