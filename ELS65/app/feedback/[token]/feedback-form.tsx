  ...
  return (
    <main className="feedback-public-wrap">
      ...
      <form className="feedback-public-card" onSubmit={submitFeedback} noValidate>
        ...
        <label>{safeSurvey.form_kind === "area-manager" ? "What was your overall experience with Emanuel Labor Services?" : safeSurvey.form_kind === "crew-lead" ? "What should ELS know from your perspective as crew lead?" : "What went well?"}
