      ...
      <section className="card">
        <div className="row">
          <div>
            ...
            <p className="muted" style={{ margin: 0 }}>Build each show from show span to labor days to sub-calls, import CSV/PDF labor lists, export a crew list, see a rough estimated crew payout, and add crew from the event view.</p>
          </div>
