...
export default function EventsClient({
  ...
  const estimate = useMemo(() => {
    ...
    return allCalls.reduce((sum, call) => {
      ...
      const fallback = masterRates.find(
        (rate) =>
          normalize(rate.city_name) === "default" &&
          normalize(rate.role_name) === key
      );
  ...
  async function deleteShow(id: string) {
    ...
    if (
      selectedDayId &&
      laborDays.some((day) => day.id === selectedDayId && day.show_id === id)
    ) {
      ...
      >
        <section className="card">
          ...
          <p className="muted small" style={{ marginTop: 0 }}>
            Create shows, set the span, and choose the rate city used for crew
            pay estimates.
          </p>
          ...
          >
            {filteredShows.map((show) => (
              ...
              >
                ...
                <div className="small muted">
                  {showBucket(show)} • Rate city: {show.rate_city || "Default"}
                </div>
              </button>
            ))}
          </div>
          ...
          <div className="list" style={{ marginTop: 16 }}>
            ...
            <label className="field">
              ...
              <input
                ...
                placeholder="Default, New Orleans, Nashville..."
              />
            </label>
        ...
        <section className="card">
          <h3 style={{ marginBottom: 6 }}>Labor days</h3>
          <p className="muted small" style={{ marginTop: 0 }}>
            Inside a show, keep labor days sorted by date so the show span stays
            organized.
          </p>

          {selectedShow ? (
            <p className="small">
              <strong>{selectedShow.name}</strong> • Estimated crew payout:{" "}
            ...
            {visibleLaborDays.map((day) => (
              <button
                ...
                style={{
                  textAlign: "left",
                  borderColor:
                    selectedDay?.id === day.id ? "#111827" : undefined,
                }}
              >
          ...
          <div className="list" style={{ marginTop: 16 }}>
            <h4 style={{ margin: 0 }}>
              {editingDayId ? "Edit labor day" : "Add labor day"}
            </h4>
              ...
              {selectedDay ? (
                <button
                  ...
                  onClick={() => {
                    ...
                    setDayForm({
                      labor_date: selectedDay.labor_date,
        ...
        <section className="card">
          ...
          <p className="muted small" style={{ marginTop: 0 }}>
            Each labor day can hold multiple areas and times. Sub-calls always
            sort by start time.
          </p>

          {selectedDay ? (
            <p className="small">
              <strong>{selectedDay.labor_date}</strong> •{" "}
              {selectedDay.label || "No label"}
            </p>
          ) : (
            <p className="muted small">Select a labor day first.</p>
          )}
              ...
              <div key={call.id} className="card compact">
                <div className="row">
                  <div>
                    ...
                    <div className="small muted">
                      {call.area} • {call.role_name} • {call.crew_needed} needed
                    </div>
                  </div>
          ...
          <div className="list" style={{ marginTop: 16 }}>
            <h4 style={{ margin: 0 }}>
              {editingCallId ? "Edit sub-call" : "Add sub-call"}
            </h4>
            ...
            <div className="grid grid-2">
              <label className="field">
                ...
                <input
                  ...
                  placeholder="General Session, Breakouts..."
                />
              </label>
              ...
              <label className="field">
                ...
                <input
                  ...
                  placeholder="General AV, Crew Lead..."
                />
              </label>
            </div>
