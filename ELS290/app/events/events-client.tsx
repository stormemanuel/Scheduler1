...
function EventsClientInner({
  ...
  function buildCoverSheetDocument(): ExportDocument | null {
    ...
    const viewLabel = eventDisplayMode === "booth" ? "Booth / Area View" : "Labor Day View";
    ...
    return {
      ...
      sections: [
        {
          heading: `${viewLabel} folder cover`,
          paragraphs: [meetUp ? `Meet-up: ${meetUp}` : "Meet-up: add meet-up inside the show notes/event meta."]
        }
      ],
    };
  }
  ...
  function buildChecklistDocument(): ExportDocument | null {
    ...
    return {
      ...
      sections: [{
        heading: "Checklist",
        columns: ["Worker", "Phone", "First schedule", "Schedule sent", "Confirmed", "3-day sent", "Day-before sent", "Day-before confirmed", "Day-of sent"],
                ...
                <div className="list">
                  ...
                  <div className="row">
                    <div>
                      ...
                      <div className="small muted">Successful Apple Shortcut, provider, and Mark sent actions automatically check the matching message stage. Worker confirmations remain manual.</div>
                    </div>
                    <div className="toolbar">
