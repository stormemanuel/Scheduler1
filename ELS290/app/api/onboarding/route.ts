    ...
    rows: rows.map((requestRow) => {
      ...
      const safeCrew = canReview
        ...
        : {
            ...
            onboarding_status: safeText(crew.onboarding_status),
            questionnaire_status: safeText(crew.questionnaire_status),
            w9_status: safeText(crew.w9_status),
            contract_status: safeText(crew.contract_status),
          };
      return {
