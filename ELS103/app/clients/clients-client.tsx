            ...
            {contactView === "labor-coordinator" ? (
              <div className="card compact" style={{ marginTop: 14 }}>
                ...
                <p className="small muted" style={{ marginBottom: 0 }}>
                  This view is for the client’s internal labor coordinators and staffing contacts. Their top-rated tech lists are intentionally hidden to keep the main client profile cleaner.
                </p>
              </div>
