          ...
          {automationDraft.sending_method === "shortcut" ? (
            <div className="card compact accent-card" style={{ marginTop: 14 }}>
              ...
              <div className="small muted" style={{ marginTop: 8 }}>
                Sender-bound universal mode sends due scheduled texts queued by this signed-in user across active Apple Shortcut Mode shows. The Run Apple Shortcut now button runs a shortcut named exactly ELS Send Due Texts. Test Shortcut JSON shows how many texts are due before the phone sends them.
              </div>
