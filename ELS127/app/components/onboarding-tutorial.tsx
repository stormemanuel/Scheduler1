...
function stepsForPath(pathname: string, role: string): TutorialStep[] {
  ...
  if (pathname.startsWith("/events")) {
    return [
      ...
      { title: "Shortcut ownership", body: "Texts send from whichever iPhone runs the Shortcut. Use the Shortcut template button in Confirmation Text Center, then paste that signed-in user's sender-bound URL into the Shortcut." },
  ...
  if (pathname.startsWith("/users")) {
    return [
      ...
      { title: "Coordinator phone setup", body: "A coordinator needs the Shortcut template installed on their own iPhone, with their own sender-bound URL pasted into it, if texts should come from their phone instead of Storm's." },
    ];
  }
  return [
