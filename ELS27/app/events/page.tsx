...
export default async function EventsPage() {
  ...
  const { shows, laborDays, subCalls, assignments, assignmentNotes, assignmentChecklists, textAutomationSettings, textMessageQueue, masterRates, setupMissing, error } = await getEventsPageData();
