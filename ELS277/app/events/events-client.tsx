...
function EventsClientInner({
  ...
  const initialPendingFeedbackResponse = initialOpenFeedback
    ? [...initialClientFeedbackResponses]
  ...
  useEffect(() => {
    if (!initialOpenFeedback || !canViewFeedbackForms || !feedbackReviewTargetId || eventDisplayMode !== "feedback") return;
  ...
  }, [initialOpenFeedback, canViewFeedbackForms, feedbackReviewTargetId, eventDisplayMode, selectedShowId, clientFeedbackResponses]);
