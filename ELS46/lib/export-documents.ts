...
function buildExportHtml(document: ExportDocument) {
  ...
  const sections = document.sections.map((section) => {
    const accentColor = /^#[0-9a-f]{6}$/i.test(asText(section.accentColor)) ? asText(section.accentColor) : "#0f766e";
...
<style>
  ...
  .export-section { border-left: 7px solid #0f766e; border-top: 2px solid #0f766e; border-right: 1px solid #0f766e; border-radius: 5px; padding: 0 0 10px 12px; page-break-inside: avoid; }
  ...
  .section-subheading { border-bottom: 2px solid #0f766e; padding: 7px 0; margin-bottom: 8px; font-weight: 700; }
