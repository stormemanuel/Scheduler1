...
export default async function CrewPage() {
  ...
  const { cityPools, crewGroups, crewRecords, masterRates, techRatings, setupMissing, error } = await getCrewPageData();
  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      ...
      <CrewClient cityPools={cityPools} crewGroups={crewGroups} initialCrew={crewRecords} masterRates={masterRates} initialRatings={techRatings} />
    </div>
  );
}
