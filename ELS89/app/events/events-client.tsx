        ...
        <div className="card compact">
          ...
          <div className="card compact" style={{ marginTop: 14, background: "#fbfcfd" }}>
            ...
            <div className="card compact" style={{ boxShadow: "none", marginTop: 12 }}>
              ...
              <div className="small muted">Use these when the reminder window has already passed, or when you want to send a reminder yourself. These texts are queued due now and will send on the next iPhone Shortcut run.</div>
              ...
              <div className="small muted" style={{ marginTop: 8 }}>
                Specific-day reminders only queue crew assigned on that labor day. Use Run Apple Shortcut now if you want the phone to send the due texts immediately.
              </div>
            </div>
          </div>
