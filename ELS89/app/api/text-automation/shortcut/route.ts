    ...
    if (allActive) {
      ...
      if (testMode) {
        return shortcutJson({
          ...
          count: 0,
          messages: [],
          message: "Shortcut endpoint is public and returning JSON correctly."
        });
      }
      ...
      return shortcutJson({ ok: true, mode: "all", active_show_count: showIds.length, count: messages.length, messages });
    }
