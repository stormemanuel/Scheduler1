...
<body>
  ...
  async function testShortcutJson(url: string, label = "Shortcut URL") {
    ...
    try {
      ...
      const data = JSON.parse(raw) as { ok?: boolean; message?: string; active_show_count?: number; mode?: string; count?: number; connected_user?: string; connected_user_id?: string; ignored_sender_query?: boolean };
      ...
      setMsg({ kind: "success", text: `${label} is public and returning valid JSON.${connected}${activeCount}${dueCount}${detail}` });
    } catch (error) {
