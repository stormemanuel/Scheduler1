    ...
    <div className="grid" style={{ gap: 16 }}>
      ...
      <section className="card">
        <div className="row" style={{ alignItems: "center" }}>
          <div>
            <h2 style={{ marginBottom: 4 }}>{year} 1099 / W-9 readiness</h2>
            <p className="muted" style={{ margin: 0 }}>Contractors marked paid at $2,000+ are flagged for 1099 prep. Use this to request only the W-9 without reopening the full onboarding packet.</p>
          </div>
