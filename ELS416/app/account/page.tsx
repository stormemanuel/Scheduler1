      ...
      <section className="card" style={{ maxWidth: 720 }}>
        ...
        <form action={changePasswordAction} className="list">
          ...
          <label className="field">
            ...
            <input name="password" type="password" minLength={8} required autoComplete="new-password" data-account-password />
          </label>
          <label className="field">
            <span>Confirm new password</span>
            <input name="confirmPassword" type="password" minLength={8} required autoComplete="new-password" data-account-password />
          </label>
          <label className="checkbox-line">
            <input id="account-show-passwords" type="checkbox" />
            <span>Show passwords</span>
          </label>
          <script
            dangerouslySetInnerHTML={{
              __html: `document.getElementById("account-show-passwords")?.addEventListener("change",function(event){document.querySelectorAll("[data-account-password]").forEach(function(input){input.type=event.currentTarget.checked?"text":"password";});});`,
            }}
          />
