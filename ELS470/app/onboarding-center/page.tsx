            ...
            <section key={row.id} className="card">
              <div className="row" style={{ alignItems: "flex-start", gap: 14 }}>
                ...
                <div className="toolbar">
                  ...
                  {rowOnboardingEmailHref(row) ? <a className="primary" style={{ background: "#16843f", borderColor: "#16843f" }} href={rowOnboardingEmailHref(row)}>Send onboarding by email</a> : null}
