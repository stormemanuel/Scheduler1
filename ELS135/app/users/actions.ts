...
const roleDefaults: Record<string, { pages: AppPageKey[]; restrictEvents: boolean; restrictCrew: boolean }> = {
  owner: { pages: ["overview", "coordinator", "crew", "events", "clients", "pipelines", "payroll", "users", "settings"], restrictEvents: false, restrictCrew: false },
  admin: { pages: ["overview", "coordinator", "crew", "events", "clients", "pipelines", "payroll", "users", "settings"], restrictEvents: false, restrictCrew: false },
  coordinator: { pages: ["overview", "coordinator", "events", "crew"], restrictEvents: true, restrictCrew: true },
