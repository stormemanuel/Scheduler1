...
function buildUniversalShortcutPollUrl(origin: string, token: string, senderUserId?: string) {
  ...
  return `${origin}/api/text-automation/shortcut?all=1&token=${encodeURIComponent(token)}&limit=125${senderBoundQuery(senderUserId)}`;
}
...
<body>
  ...
  function renderAutomationPanel() {
    ...
    const universalShortcutPollUrl = buildUniversalShortcutPollUrl(origin, effectiveShortcutToken, currentUserId);
    const ownerUniversalShortcutPollUrl = buildOwnerUniversalShortcutPollUrl(origin, effectiveShortcutToken);
