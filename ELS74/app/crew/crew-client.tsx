...
function isCrewLeadContact(record: CrewRecord) {
  ...
  return text.includes("crew lead") || text.includes("lead labor") || text.includes("labor lead") || text === "lead" || text.includes(" lead ");
}
    ...
    try {
      ...
      for (const [index, values] of rows.slice(1).entries()) {
        ...
        try {
          ...
          errors.push(`Row ${index + 2}: ${error instanceof Error ? error.message : "city/state pool failed"}`);
          continue;
        }
        ...
        <div className="crew-bigin-shell" style={{ display: "grid", gridTemplateColumns: "260px minmax(360px, 1fr)", minHeight: 720 }}>
          ...
          <section style={{ borderRight: "1px solid var(--line)", padding: 16 }}>
            ...
            <div className="card compact" style={{ background: "#fbfcfd", marginBottom: 14 }}>
              ...
              {crewLeadContactsForPool.length ? (
                ...
                <p className="small muted" style={{ marginBottom: 0 }}>
                  No crew leads detected in this pool yet. Add “Crew Lead” as a position or group name for lead contacts.
                </p>
              )}
            </div>
            ...
            <div className="toolbar" style={{ marginBottom: 14 }}>
              ...
              <button className="ghost" type="button" onClick={() => importInputRef.current?.click()} disabled={saving}>Master CSV import</button>
              ...
              <span className="muted small">Use the info button for accepted headings, or download the template and fill it in.</span>
            </div>
