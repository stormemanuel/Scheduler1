...
ELS44 update: Added requested-back / Project Manager Favorite buttons under worker Notes / Rating and the Tech Ratings panel. Favorites save by selected project manager/client contact and build a separate PM Favorites list.
