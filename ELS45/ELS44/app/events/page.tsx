...
export default async function EventsPage() {
  ...
  const { shows, laborDays, subCalls, assignments, assignmentNotes, assignmentChecklists, textAutomationSettings, textMessageQueue, techRatings, projectManagerFavorites, masterRates, setupMissing, error } = await getEventsPageData();
  ...
  return (
    <div className="grid" style={{ gap: 16 }}>
      ...
      <EventsClient
        ...
        initialProjectManagerFavorites={projectManagerFavorites}
