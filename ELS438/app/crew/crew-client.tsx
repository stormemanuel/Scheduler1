...
async function queueOnboardingRequestForShortcut(record: CrewRecord, requestType: OnboardingRequestType = "full_onboarding") {
  ...
  return data as { link?: string; message?: string; request_type?: string };
}
                          ...
                          <ContactDetail
                            ...
                            onQueueOnboarding={async () => {
                              try {
                                ...
                                setMessageKind("success");
                                setMessage(result.message || "Onboarding request queued for the iPhone Shortcut.");
                            ...
                            onQueueW9Only={async () => {
                              try {
                                ...
                                setMessageKind("success");
                                setMessage(result.message || "W-9 request queued for the iPhone Shortcut.");
                                setCrewRecords((current) => current.map((item) => item.id === record.id ? {
                                  ...item,
                                  w9_status: "requested",
                            ...
                            onQueueContractOnly={async () => {
                              try {
                                ...
                                setMessageKind("success");
                                setMessage(result.message || "Contract-only request queued for the iPhone Shortcut.");
                                setCrewRecords((current) => current.map((item) => item.id === record.id ? {
                                  ...item,
                            ...
                            onQueueProfilePhotoOnly={async () => {
                              try {
                                ...
                                setMessageKind("success");
                                setMessage(result.message || "Profile photo request queued for the iPhone Shortcut.");
                                setCrewRecords((current) => current.map((item) => item.id === record.id ? {
                                  ...item,
                                  onboarding_request_sent_at: new Date().toISOString(),
                                } : item));
          ...
          {canSendOnboarding ? (
            <button
              ...
              onClick={() => {
                ...
                const confirmed = window.confirm(
                  `Create a secure full-onboarding link for ${record.name} and queue the text for your iPhone Shortcut?`,
                );
