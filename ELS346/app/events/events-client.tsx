...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .col-number { width: 0.28in; text-align: center; }
  .col-name { width: 2.55in; }
  .col-date { width: 0.74in; text-align: center; }
  .col-role { width: 1.05in; }
  .col-time { width: 0.82in; text-align: center; }
  .col-signature { width: 2.58in; }
...
<main>
  ...
  function renderSignInSheetModal() {
    ...
    return createPortal(
      <div className="modal-backdrop" role="dialog" aria-modal="true" aria-label="Sign In / Sign Out Sheet">
            ...
            <div className="grid" style={{ gap: 16 }}>
              <div className="card compact">
                ...
                <div className="toolbar" style={{ marginTop: 12 }}>
                  ...
                  <button type="button" className="ghost" onClick={() => setSignInSheetModalOpen(true)}>Sign In / Out Sheet</button>
