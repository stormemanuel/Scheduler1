...
function buildRows(selectedGroup: string, rates: MasterRateRecord[]): RateRow[] {
  ...
  return roleNames.map((roleName) => {
    ...
    return {
      ...
      overtime_multiplier: toMultiplierString(override?.overtime_multiplier, base?.overtime_multiplier ?? 1.5),
      doubletime_multiplier: toMultiplierString(override?.doubletime_multiplier, base?.doubletime_multiplier ?? 2.0),
